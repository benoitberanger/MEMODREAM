...
if ~isempty(figPtr) % Figure exists so brings it to the focus
    ...
    handles.(b_sleep.tag) = uicontrol(handles.uipanel_Instructions,...
        'Style','pushbutton',...
        'Units', 'Normalized',...
    ...
    handles.(b_execution.tag) = uicontrol(handles.uipanel_Instructions,...
        'Style','pushbutton',...
        'Units', 'Normalized',...
    ...
    handles.(b_imagination.tag) = uicontrol(handles.uipanel_Instructions,...
        'Style','pushbutton',...
        'Units', 'Normalized',...
